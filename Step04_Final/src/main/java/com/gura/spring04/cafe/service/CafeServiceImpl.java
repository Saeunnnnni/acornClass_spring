...
public class CafeServiceImpl implements CafeService{
	...
	//페이징 처리, 검색어 기능을 고려한 비즈니스 로직 처리하는 메소드
	//request에 담아도 되고 modelAndView에 담아도 상관 없다.
	@Override
	...
	public void saveContent(CafeDto dto) {
		//title, content, writer 정보가 들어 있는 CafeDto를 dao에 전달해서 DB에 저장 되도록 한다.
		cafeDao.insert(dto);
