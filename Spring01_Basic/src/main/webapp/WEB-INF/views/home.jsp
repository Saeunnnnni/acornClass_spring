...
<body>
	<div class="container">
		<h1>인덱스 페이지입니다.</h1>
		<ul>
			<li><a href="${pageContext.request.contextPath}/member/insertform">파라피터 추출 테스트</a></li>
			...
			<li><a href="${pageContext.request.contextPath}/member/delete?num=1">작업 후 리다이렉트 응답받기</a></li>
