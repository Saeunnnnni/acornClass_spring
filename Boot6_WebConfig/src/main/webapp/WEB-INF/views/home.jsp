...
<body>
   <div class="container">
      ...
      <img src="${pageContext.request.contextPath }/image/bottle.png"/>
      <img src="${pageContext.request.contextPath }/images/bottle.png"/>
      <img src="${pageContext.request.contextPath }/aaa/puff1.png"/>
        <img src="${pageContext.request.contextPath }/aaa/puff2.png"/>
      <ul>
         <li><a href="${pageContext.request.contextPath }/html/hello.html">html 페이지</a></li>
         <%-- static 폴더에는 jsp 페이지를 위치시킬 수 없다 --%>
         ...
         <li><a href="${pageContext.request.contextPath }/test.jsp">jsp 페이지</a></li>
          <li><a href="${pageContext.request.contextPath }/cafe/insertform">카페글쓰기</a></li>
          <li><a href="${pageContext.request.contextPath }/file/uploadform">파일 업로드 테스트</a></li>
      </ul>
      <h3>공지사항</h3>
      <ul>
