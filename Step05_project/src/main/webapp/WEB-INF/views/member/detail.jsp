...
<body>
<div class="container animate_animated animate__bounceInDown">
     ...
     <!-- 댓글 목록 -->
            ...
            <c:forEach var="tmp" items="${commentList }">
               <c:choose>
                  ...
                  <c:otherwise>
                     ...
                     <!-- 댓글의 번호와 원글의 댓글이 같지 않으면 대댓글로 확인이 되어서 padding-left:50px을 주어서 들여쓰기 -->
                     <c:if test="${tmp.num ne tmp.comment_group }">
                        <li id="reli${tmp.num }" style="padding-left:50px;">
                           ...
                           <dl>
                              ...
                              <dd>
                              	<!-- pre요소를 이용해서 text입력 , pre요소를 사용한 이유는 개행기호 등을 출력해주기때문에! -->
      ...
      <!-- 회전하는 이미지 ! 아래 끝까지 스크롤 되면 로딩이미지 나오게 !  -->
      <div class="loader">
      ...
      document.querySelector(".insert-form")
         .addEventListener("submit", function(e){
            ...
            if(!isLogin){
               ...
               //로그인 폼으로 이동 시킨다.
               location.href=
                  "${pageContext.request.contextPath}/users/loginform?url=${pageContext.request.contextPath}/member/detail?num=${dto.num}";
            }
         });
