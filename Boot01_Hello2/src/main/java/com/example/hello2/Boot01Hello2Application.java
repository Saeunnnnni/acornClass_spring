...
public class Boot01Hello2Application {
	...
	public static void main(String[] args) {
		...
		r1.up();
		r1.down();
		//스프링이관리하는 객체 중에서 myRemocon이라는 이름의 객체를 얻어와서 원래  type으로 castiong 해서 사용하기 
		Remocon r2=(Remocon)ctx.getBean("tvRemocon");
		r2.up();
		r2.down();
		//에러가 나지 않으려면 bean의 이름으로 찾아가야한다.
