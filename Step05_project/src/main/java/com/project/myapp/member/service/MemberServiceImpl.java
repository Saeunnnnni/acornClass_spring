...
import com.project.myapp.exception.NotDeleteException;
import com.project.myapp.member.dao.MemberDao;
...
public class MemberServiceImpl implements MemberService{
	...
	@Override
	public void updateContent(MemberDto dto) {
		dao.update(dto);
		
	}

	@Override
	public void deleteCountent(int num, HttpServletRequest request) {
		String id=(String)request.getSession().getAttribute("id");
		MemberDto dto = dao.getData(num);
		
		if(!id.contentEquals(dto.getWriter())) {
			throw new NotDeleteException("글을 지울 수 없습니다.");
		}
		dao.delete(num);
	}
	...
	@Override
	public void saveContent(MemberDto dto, HttpServletRequest request) {
