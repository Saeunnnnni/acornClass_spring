package com.example.boot6.config;
...
import com.example.boot6.interceptor.LoginInterceptor;
...
public class WebConfig implements WebMvcConfigurer{
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(loginInter)
			...
			.excludePathPatterns("/users/loginform","/users/loginform" ,"/users/login", 
					"/users/signup_form", "/users/signup", "/cafe/list","/cafe/detail","/cafe/ajax_comment_list");
